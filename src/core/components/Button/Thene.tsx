...
export const mpxButtonTheme = createTheme({
    'base': 'relative flex items-center justify-center fl rounded-lg text-center font-medium focus:outline-none focus:ring-4',
    ...
    'color': {
        ...
        'blue': 'bg-blue-400 text-white hover:bg-blue-800 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800',
